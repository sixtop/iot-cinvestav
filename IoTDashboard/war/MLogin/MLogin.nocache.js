function MLogin(){
  ...
  MLogin.__sendStats = sendStats;
  MLogin.__moduleName = $intern_4;
  MLogin.__errFn = null;
  MLogin.__moduleBase = $intern_6;
  MLogin.__softPermutationId = 0;
  MLogin.__computePropValue = null;
  MLogin.__getPropMap = null;
  MLogin.__gwtInstallCode = function(){
  }
  ;
  MLogin.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MLogin.onScriptDownloaded = function(code_0){
  ...
  MLogin.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MLogin.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MLogin.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MLogin.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MLogin.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MLogin.__getPropMap;
    ...
    MLogin.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MLogin.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MLogin.__moduleBase;
