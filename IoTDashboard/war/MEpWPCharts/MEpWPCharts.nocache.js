...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MEpWPCharts" because\n';
  ...
  $wnd.__gwt_activeModules['MEpWPCharts'] = {
    'moduleName' : 'MEpWPCharts',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/MEpWPCharts.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MEpWPCharts'].superdevmode = true;

  var expectedSuffix = '/MEpWPCharts.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MEpWPCharts + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MEpWPCharts';
  var devModeSessionKey = '__gwtDevModeSession:MEpWPCharts';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MEpWPCharts/MEpWPCharts.nocache.js';
  ...
  $wnd.__gwt_activeModules['MEpWPCharts'].canRedirect = true;
  $wnd.__gwt_activeModules['MEpWPCharts'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MEpWPCharts?user.agent=' + ua + '&_callback=' + callback;
