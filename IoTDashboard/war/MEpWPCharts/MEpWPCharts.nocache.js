function MEpWPCharts(){
  ...
  MEpWPCharts.__sendStats = sendStats;
  MEpWPCharts.__moduleName = $intern_4;
  MEpWPCharts.__errFn = null;
  MEpWPCharts.__moduleBase = $intern_6;
  MEpWPCharts.__softPermutationId = 0;
  MEpWPCharts.__computePropValue = null;
  MEpWPCharts.__getPropMap = null;
  MEpWPCharts.__gwtInstallCode = function(){
  }
  ;
  MEpWPCharts.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MEpWPCharts.onScriptDownloaded = function(code_0){
  ...
  MEpWPCharts.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MEpWPCharts.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MEpWPCharts.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MEpWPCharts.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MEpWPCharts.__getPropMap = function(){
      var result = {};
    ...
    ;
    MEpWPCharts.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MEpWPCharts.__getPropMap;
    ...
    MEpWPCharts.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MEpWPCharts.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MEpWPCharts.__moduleBase;
...
MEpWPCharts.succeeded = MEpWPCharts();
