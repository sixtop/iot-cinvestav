function MEpSensor(){
  ...
  MEpSensor.__sendStats = sendStats;
  MEpSensor.__moduleName = $intern_4;
  MEpSensor.__errFn = null;
  MEpSensor.__moduleBase = $intern_6;
  MEpSensor.__softPermutationId = 0;
  MEpSensor.__computePropValue = null;
  MEpSensor.__getPropMap = null;
  MEpSensor.__gwtInstallCode = function(){
  }
  ;
  MEpSensor.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MEpSensor.onScriptDownloaded = function(code_0){
  ...
  MEpSensor.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MEpSensor.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MEpSensor.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MEpSensor.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MEpSensor.__getPropMap = function(){
      var result = {};
    ...
    ;
    MEpSensor.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MEpSensor.__getPropMap;
    ...
    MEpSensor.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MEpSensor.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MEpSensor.__moduleBase;
