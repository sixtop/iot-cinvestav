...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MEpWPUser" because\n';
  ...
  $wnd.__gwt_activeModules['MEpWPUser'] = {
    'moduleName' : 'MEpWPUser',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/MEpWPUser.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MEpWPUser'].superdevmode = true;

  var expectedSuffix = '/MEpWPUser.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MEpWPUser + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MEpWPUser';
  var devModeSessionKey = '__gwtDevModeSession:MEpWPUser';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MEpWPUser/MEpWPUser.nocache.js';
  ...
  $wnd.__gwt_activeModules['MEpWPUser'].canRedirect = true;
  $wnd.__gwt_activeModules['MEpWPUser'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MEpWPUser?user.agent=' + ua + '&_callback=' + callback;
