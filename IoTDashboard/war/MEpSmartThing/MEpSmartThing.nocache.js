...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MEpSmartThing" because\n';
  ...
  $wnd.__gwt_activeModules['MEpSmartThing'] = {
    'moduleName' : 'MEpSmartThing',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/MEpSmartThing.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MEpSmartThing'].superdevmode = true;

  var expectedSuffix = '/MEpSmartThing.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MEpSmartThing + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MEpSmartThing';
  var devModeSessionKey = '__gwtDevModeSession:MEpSmartThing';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MEpSmartThing/MEpSmartThing.nocache.js';
  ...
  $wnd.__gwt_activeModules['MEpSmartThing'].canRedirect = true;
  $wnd.__gwt_activeModules['MEpSmartThing'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING MEpSmartThing';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MEpSmartThing?user.agent=' + ua + '&_callback=' + callback;
