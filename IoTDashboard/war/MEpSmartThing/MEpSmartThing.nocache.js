function MEpSmartThing(){
  ...
  MEpSmartThing.__sendStats = sendStats;
  MEpSmartThing.__moduleName = $intern_4;
  MEpSmartThing.__errFn = null;
  MEpSmartThing.__moduleBase = $intern_6;
  MEpSmartThing.__softPermutationId = 0;
  MEpSmartThing.__computePropValue = null;
  MEpSmartThing.__getPropMap = null;
  MEpSmartThing.__gwtInstallCode = function(){
  }
  ;
  MEpSmartThing.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MEpSmartThing.onScriptDownloaded = function(code_0){
  ...
  MEpSmartThing.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MEpSmartThing.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MEpSmartThing.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MEpSmartThing.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MEpSmartThing.__getPropMap = function(){
      var result = {};
    ...
    ;
    MEpSmartThing.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MEpSmartThing.__getPropMap;
    ...
    MEpSmartThing.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MEpSmartThing.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MEpSmartThing.__moduleBase;
...
MEpSmartThing.succeeded = MEpSmartThing();
