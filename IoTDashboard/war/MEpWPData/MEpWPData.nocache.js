...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MEpWPData" because\n';
  ...
  $wnd.__gwt_activeModules['MEpWPData'] = {
    'moduleName' : 'MEpWPData',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/MEpWPData.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MEpWPData'].superdevmode = true;

  var expectedSuffix = '/MEpWPData.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MEpWPData + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MEpWPData';
  var devModeSessionKey = '__gwtDevModeSession:MEpWPData';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MEpWPData/MEpWPData.nocache.js';
  ...
  $wnd.__gwt_activeModules['MEpWPData'].canRedirect = true;
  $wnd.__gwt_activeModules['MEpWPData'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MEpWPData?user.agent=' + ua + '&_callback=' + callback;
