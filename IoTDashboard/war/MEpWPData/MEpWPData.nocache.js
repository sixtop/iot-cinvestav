function MEpWPData(){
  ...
  MEpWPData.__sendStats = sendStats;
  MEpWPData.__moduleName = $intern_4;
  MEpWPData.__errFn = null;
  MEpWPData.__moduleBase = $intern_6;
  MEpWPData.__softPermutationId = 0;
  MEpWPData.__computePropValue = null;
  MEpWPData.__getPropMap = null;
  MEpWPData.__gwtInstallCode = function(){
  }
  ;
  MEpWPData.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MEpWPData.onScriptDownloaded = function(code_0){
  ...
  MEpWPData.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MEpWPData.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MEpWPData.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MEpWPData.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MEpWPData.__getPropMap = function(){
      var result = {};
    ...
    ;
    MEpWPData.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MEpWPData.__getPropMap;
    ...
    MEpWPData.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MEpWPData.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MEpWPData.__moduleBase;
