...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MEpUser" because\n';
  ...
  $wnd.__gwt_activeModules['MEpUser'] = {
    'moduleName' : 'MEpUser',
    'bindings' : function() {
      return {};
    }
 ...
 * "/MEpUser.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MEpUser'].superdevmode = true;

  var expectedSuffix = '/MEpUser.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MEpUser + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MEpUser';
  var devModeSessionKey = '__gwtDevModeSession:MEpUser';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MEpUser/MEpUser.nocache.js';
  ...
  $wnd.__gwt_activeModules['MEpUser'].canRedirect = true;
  $wnd.__gwt_activeModules['MEpUser'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MEpUser?user.agent=' + ua + '&_callback=' + callback;
