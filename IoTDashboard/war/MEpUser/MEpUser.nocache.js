function MEpUser(){
  ...
  MEpUser.__sendStats = sendStats;
  MEpUser.__moduleName = $intern_4;
  MEpUser.__errFn = null;
  MEpUser.__moduleBase = $intern_6;
  MEpUser.__softPermutationId = 0;
  MEpUser.__computePropValue = null;
  MEpUser.__getPropMap = null;
  MEpUser.__gwtInstallCode = function(){
  }
  ;
  MEpUser.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MEpUser.onScriptDownloaded = function(code_0){
  ...
  MEpUser.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MEpUser.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MEpUser.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MEpUser.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MEpUser.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MEpUser.__getPropMap;
    ...
    MEpUser.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MEpUser.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MEpUser.__moduleBase;
