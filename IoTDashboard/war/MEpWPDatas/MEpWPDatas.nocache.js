...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MEpWPDatas" because\n';
  ...
  $wnd.__gwt_activeModules['MEpWPDatas'] = {
    'moduleName' : 'MEpWPDatas',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/MEpWPDatas.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MEpWPDatas'].superdevmode = true;

  var expectedSuffix = '/MEpWPDatas.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MEpWPDatas + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MEpWPDatas';
  var devModeSessionKey = '__gwtDevModeSession:MEpWPDatas';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MEpWPDatas/MEpWPDatas.nocache.js';
  ...
  $wnd.__gwt_activeModules['MEpWPDatas'].canRedirect = true;
  $wnd.__gwt_activeModules['MEpWPDatas'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MEpWPDatas?user.agent=' + ua + '&_callback=' + callback;
