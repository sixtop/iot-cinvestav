function MEpWPDatas(){
  ...
  MEpWPDatas.__sendStats = sendStats;
  MEpWPDatas.__moduleName = $intern_4;
  MEpWPDatas.__errFn = null;
  MEpWPDatas.__moduleBase = $intern_6;
  MEpWPDatas.__softPermutationId = 0;
  MEpWPDatas.__computePropValue = null;
  MEpWPDatas.__getPropMap = null;
  MEpWPDatas.__gwtInstallCode = function(){
  }
  ;
  MEpWPDatas.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MEpWPDatas.onScriptDownloaded = function(code_0){
  ...
  MEpWPDatas.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MEpWPDatas.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MEpWPDatas.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MEpWPDatas.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MEpWPDatas.__getPropMap = function(){
      var result = {};
    ...
    ;
    MEpWPDatas.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MEpWPDatas.__getPropMap;
    ...
    MEpWPDatas.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MEpWPDatas.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MEpWPDatas.__moduleBase;
...
MEpWPDatas.succeeded = MEpWPDatas();
