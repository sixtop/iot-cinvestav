...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MEpData" because\n';
  ...
  $wnd.__gwt_activeModules['MEpData'] = {
    'moduleName' : 'MEpData',
    'bindings' : function() {
      return {};
    }
 ...
 * "/MEpData.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MEpData'].superdevmode = true;

  var expectedSuffix = '/MEpData.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MEpData + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MEpData';
  var devModeSessionKey = '__gwtDevModeSession:MEpData';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MEpData/MEpData.nocache.js';
  ...
  $wnd.__gwt_activeModules['MEpData'].canRedirect = true;
  $wnd.__gwt_activeModules['MEpData'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MEpData?user.agent=' + ua + '&_callback=' + callback;
