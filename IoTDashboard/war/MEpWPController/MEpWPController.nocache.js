function MEpWPController(){
  ...
  MEpWPController.__sendStats = sendStats;
  MEpWPController.__moduleName = $intern_4;
  MEpWPController.__errFn = null;
  MEpWPController.__moduleBase = $intern_6;
  MEpWPController.__softPermutationId = 0;
  MEpWPController.__computePropValue = null;
  MEpWPController.__getPropMap = null;
  MEpWPController.__gwtInstallCode = function(){
  }
  ;
  MEpWPController.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MEpWPController.onScriptDownloaded = function(code_0){
  ...
  MEpWPController.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MEpWPController.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MEpWPController.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MEpWPController.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MEpWPController.__getPropMap = function(){
      var result = {};
    ...
    ;
    MEpWPController.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MEpWPController.__getPropMap;
    ...
    MEpWPController.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MEpWPController.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MEpWPController.__moduleBase;
...
MEpWPController.succeeded = MEpWPController();
