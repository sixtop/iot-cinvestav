...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "MIndex" because\n';
  ...
  $wnd.__gwt_activeModules['MIndex'] = {
    'moduleName' : 'MIndex',
    'bindings' : function() {
      return {};
    }
 ...
 * "/MIndex.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['MIndex'].superdevmode = true;

  var expectedSuffix = '/MIndex.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + MIndex + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:MIndex';
  var devModeSessionKey = '__gwtDevModeSession:MIndex';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/MIndex/MIndex.nocache.js';
  ...
  $wnd.__gwt_activeModules['MIndex'].canRedirect = true;
  $wnd.__gwt_activeModules['MIndex'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/MIndex?user.agent=' + ua + '&_callback=' + callback;
