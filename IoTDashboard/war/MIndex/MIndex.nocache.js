function MIndex(){
  ...
  MIndex.__sendStats = sendStats;
  MIndex.__moduleName = $intern_4;
  MIndex.__errFn = null;
  MIndex.__moduleBase = $intern_6;
  MIndex.__softPermutationId = 0;
  MIndex.__computePropValue = null;
  MIndex.__getPropMap = null;
  MIndex.__gwtInstallCode = function(){
  }
  ;
  MIndex.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ...
  function installScript(filename){
    ...
    MIndex.onScriptDownloaded = function(code_0){
  ...
  MIndex.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  MIndex.__installRunAsyncCode = function(code_0){
    var docbody = getInstallLocation();
  ...
  function processMetas(){
    ...
    MIndex.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return MIndex.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    MIndex.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = MIndex.__getPropMap;
    ...
    MIndex.__softPermutationId = softPermutationId;
  ...
  processMetas();
  MIndex.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = MIndex.__moduleBase;
