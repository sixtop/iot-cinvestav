...
public class EpWPDatas extends IoTEntryPoint {
	...
	private FlexTable tablePictures = new FlexTable();
								...
								new AsyncCallback<List<MeasureDTO>>() {
									...
									public void onSuccess(final List<MeasureDTO> result) {
										...
										if (type.toUpperCase().equals("PHOTO")) {
											...
											for (int row = 0; row < numRows; row++) {
												for (int col = 0; col < numColumns; col++) {
													...
													if (i < result.size()) {
														...
														String x = result.get(i).getMeasure();
											...
											formPanel.setCellHorizontalAlignment(decPanel,HasHorizontalAlignment.ALIGN_CENTER);
